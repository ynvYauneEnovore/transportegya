            ...
            <div class="content-wrapper transition-all duration-150 ltr:ml-[248px] rtl:mr-[248px]" id="content_wrapper">
                        ...
                        <div id="content_layout">
                            ...
                            <div>
                                <div class="flex justify-between flex-wrap items-center mb-6">
                                    <div class="card-text h-full" style="width: 100%;">
                                        <div class="space-y-5">
                                            <div class="slider carousel-interval owl-carousel">
                                                <div class="w-full text-center bg-gray-300 p-4">

                                                    <div class="space-y-5 profile-page">
                                                        <div class="profiel-wrap px-[35px] pb-10 md:pt-[10px] pt-10 rounded-lg bg-white dark:bg-slate-800 lg:flex lg:space-y-0
                space-y-6 justify-between items-end relative z-[1]">
                                ...
                                ring-slate-100 relative">
                                                                            <img src="assets-backend/images/users/user-1.jpg" alt="" class="w-full h-full object-cover rounded-full">
